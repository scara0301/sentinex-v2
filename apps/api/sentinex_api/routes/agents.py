...
def _extract_bundle(archive_path: Path, extract_dir: Path) -> None:
    """Extract zip or tar archive into extract_dir."""
    import zipfile
    import tarfile
...
async def upload_agent(
    ...
    # Persist bundle to upload_dir/<workspace_id>/<name>/
    ...
    # Determine next version for this workspace+name
    repo = AgentRepo(db)
